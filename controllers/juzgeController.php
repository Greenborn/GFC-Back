...
class JuzgeController extends BaseController {
    ...
    public function prepareDataProvider(){
      ...
      if (!empty($contest_id) && is_numeric($contest_id)) {
        ...
        throw new BadRequestHttpException('Especificar el id concurso del que se quiere saber los jueces inscribibles');
      }
